            ...
            <div className="bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
              <div className="">
                {showClose && (
                  <div
                    onClick={handleClose}
                    className="absolute right-2 top-0 mx-auto flex h-12 w-12 flex-shrink-0 items-center justify-center sm:mx-0 sm:h-10 sm:w-10"
                  >
                    <svg
                ...
                <div className="mt-3 text-center sm:mt-0 sm:text-left">
                  <h3
                    className="text-base text-[28px] font-semibold leading-[42px] text-gray-900 text-center"
                    id="modal-title"
                  >
                    {ariaLabel}
                  </h3>
